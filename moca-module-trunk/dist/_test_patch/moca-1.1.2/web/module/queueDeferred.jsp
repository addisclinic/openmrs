   ...
   function clickqueuelimit(i)
   {
    ...
    function pageNationNext(queuelistcount)
    {
        ...
        else
        {
	          ...
	          //document.getElementById("hidprevid").value = document.getElementById("hidnextid").value;
    ...
    {   
        ...
        {
            //document.getElementById("hidnextid").value = document.getElementById("hidprevid").value;
...
<form action="${pageContext.request.contextPath}/module/moca/queueDeferred.form" method="post" id="queueFormid" name="queueForm">
<input type=hidden name="chklist" id="chklistid" />
<b class="boxHeader">

<!-- <c:set var="prochk" value="<%= request.getParameter(\"checkpro\")%>" />
<c:if test="${prochk != 'on'}">

<input type="checkbox" name="checkpro" id="chkproid" title="Check to Search through Procedure" />
</c:if>
<c:if test="${prochk == 'on'}">

<input type="checkbox" name="checkpro" id="chkproid" title="Check to Search through Procedure" checked=true />
</c:if> -->
